            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-9 px-2">
              ...
              <div className="col-span-4 w-full h-full ">
                <div className="w-full h-full bg-indigo-400 rounded-md p-3 ">
                  ...
                  <p className="text-gray-100 text-md">{crop.timofApplied}</p>
                </div>
              </div>
              ...
              {midterm.isDisapproved && (
                <>
                  ...
                  <div className="col-span-4 w-full h-full ">
                    <div className="w-full h-full bg-red-400 rounded-md p-2 md:pl-4">
                      <h1 className="text-white text-xl font-medium py-2">
                        Midterm Verification Disapproved By Authority on
                      </h1>
                      <p className="text-gray-100  text-md">
                        {midterm.timeofVerified}
                      </p>
